...
public class ExampleModel  {
    ...
    public final ObservableList<Byte> connectedPositions        = new ObservableList<>(new ArrayList<>());
    public final ObservableList<String> errorMessages        = new ObservableList<>(new ArrayList<>());
